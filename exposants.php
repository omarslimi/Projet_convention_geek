<?php require_once 'controllers/exposantsRegisteController.php'; ?>
<!DOCTYPE html>
...
<nav class="navbar navbar-expand-lg navbar-light bg-dark sticky-top">
    ...
    <h2 class="text-center mt-4">Inscription/Connection</h2>
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-6 border">
                <h3>Je m'inscrit</h3>
                <form action="exposants.php" method="POST">
                    <div class="container">
                        <div class="row">
                            <div class="col-6">
                        ...
                        <div>
                            <label for="user_duration" class="form-label">Le type d’exposition</label>
                            <select name="user_duration" id="user_duration" class="form-select <?= isset($formErrors['user_duration']) ? 'is-invalid' : '' ?>">
                            <option disabled selected>Choisissez</option>
                            <option value="1 Jour" <?= isset($_POST['user_duration']) && $_POST['user_duration'] == '1 Jour' ? 'selected' : '' ?>>1 Jour</option>
                            <option value="2 Jours" <?= isset($_POST['user_duration']) && $_POST['user_duration'] == '2 Jours' ? 'selected' : '' ?>>2 Jours</option>
                        ...
                        <div>
                        <label for="user_NameExposants">nom de l'exposants</label>
                                <input type="text" class=" form-control <?= isset($formErrors['user_NameExposants']) ? 'is-invalid' : ''; ?>" value="<?= @$_POST['user_NameExposants']; ?>" name="user_NameExposants" id="user_NameExposants" placeholder="Le monde du Livre"/>
                                <div id="messageNameExposants"></div>
                                <?php if (isset($formErrors['user_NameExposants'])) { ?>
                                    <p class="invalid-feedback"><?= $formErrors['user_NameExposants'] ?></p>
                                <?php } ?>
                        </div>
                        <div class="md-form mt-3">
                                <label for="file" class="mb-2">Image de présentation :</label>
                                <div>
...
<div class="footer bg-dark" id="footerVisitors">
    ...
    <script src="assets/js/exposantsCheck.js"></script>
</body>
</html>